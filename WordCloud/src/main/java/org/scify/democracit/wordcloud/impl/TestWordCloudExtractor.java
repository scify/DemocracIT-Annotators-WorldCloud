...
import org.scify.democracit.wordcloud.freqextract.NormalizedFrequencyExtractor;
...
//        return pmi / (- Math.log(((double) biFreq/dCorpus)));
    ...
    protected IFreqExtractor initFreqExtractor(String sCandLang,
        ...
        return new NormalizedFrequencyExtractor(locale, chooseLemmatizer(locale, bLemmatizer), logger);
    }
